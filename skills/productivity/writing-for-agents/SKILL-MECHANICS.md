...
Shared reference that two user-invoked skills both need can live in neither: with no description in the model's context, neither can fire the other. Push it to a plain file outside the skill system: external reference any skill can point at.
