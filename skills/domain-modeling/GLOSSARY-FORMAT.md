...
- An **Order** produces one **Invoice** after delivery
```
...
- **Relationships are optional.** Add the section when how terms relate (cardinality, ownership, sequence) is not obvious from their definitions.
