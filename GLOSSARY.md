...
A collection of agent skills (slash commands and behaviors) loaded by coding agent. Skills are organized into buckets and consumed by per-repo configuration emitted by `/setup-supermatt-skills`.
